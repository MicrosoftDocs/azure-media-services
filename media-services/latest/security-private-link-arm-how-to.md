...
Read [Quickstart: Create and deploy ARM templates by using the Azure portal](https://docs.microsoft.com/azure-resource-manager/templates/quickstart-create-templates-use-the-portal.md).
