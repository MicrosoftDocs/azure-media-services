...
ms.date: 05/17/2022
ms.author: inhenkel
title: Update a streaming endpoint with Python
---
...
:::code language="python" source="~/../media-services-v3-python/snippets/streaming-endpoints.py" id="BeginUpdateStreamingEndpoint" :::
