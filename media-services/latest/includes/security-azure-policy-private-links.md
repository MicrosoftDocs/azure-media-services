...
Azure Media Services supports several built-in use case based [Azure Policy](/azure/governance/policy/overview) definitions.
...
For details on how to deploy and use Azure Policy definitions see the article ["What is Azure Policy?"](/azure/governance/policy/overview)