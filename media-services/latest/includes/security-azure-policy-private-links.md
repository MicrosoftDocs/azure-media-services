...
Azure Media Services supports several built-in use case based [Azure Policy](https://docs.microsoft.com/governance/policy/overview.md) definitions. 
...
For details on how to deploy and use Azure Policy definitions see the article ["What is Azure Policy?"](https://docs.microsoft.com/governance/policy/overview.md)