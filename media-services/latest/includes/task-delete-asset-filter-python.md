...
ms.date: 05/17/2022
ms.author: inhenkel
title: Delete an asset filter with Python
---

### Delete an asset filter with Python
...
:::code language="python" source="~/../media-services-v3-python/snippets/filters.py" id="DeleteAssetFilter" :::
