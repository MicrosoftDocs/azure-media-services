...
ms.date: 05/17/2022
ms.author: inhenkel
title: Create a live event with Python
---

### Create a live event with Python
...
:::code language="python" source="~/../media-services-v3-python/snippets/live-event.py" id="CreateLiveEvent" :::