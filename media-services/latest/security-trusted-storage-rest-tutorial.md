...
If you don't know how to get your tenant ID and subscription ID, see [How to find your subscription and tenant ID](/azure/azure-portal/get-subscription-tenant-id).
