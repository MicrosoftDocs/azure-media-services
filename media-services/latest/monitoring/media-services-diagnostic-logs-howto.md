...
- [Azure Monitor Diagnostic logs](/azure/azure-monitor/essentials/platform-logs-overview)
- [How to collect and consume log data from your Azure resources](/azure/azure-monitor/essentials/platform-logs-overview)
